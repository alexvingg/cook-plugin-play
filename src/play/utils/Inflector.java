...
public class Inflector {
    ...
    protected void initialize() {
        ...
        inflect.addPluralize("x$", "x");
        inflect.addPluralize("ao", "oes"); //ex. aviao
        inflect.addPluralize("([a|e|o|u])l$", "$1is"); //ex. papel
        inflect.addPluralize("(i)l$", "$1s"); //ex. fuzil
        inflect.addPluralize("([m|n])$", "ns"); // ex. viagem
        inflect.addPluralize("([r|s|z])$", "$1es"); // ex. amor
...
//        inflect.addPluralize("(oxen|octopi|viri|aliases|quizzes)$", "$1"); // special rules
        ...
        inflect.addSingularize("is$", "il"); //ex. fuzil
        inflect.addSingularize("([a|e|o|u])is$", "$1l"); //ex. papeis
        inflect.addSingularize("(oes)$", "ao");
        inflect.addSingularize("(aes)$", "ao");
        inflect.addSingularize("(ns)$", "m"); // ex. viagens
        //inflect.addSingularize("([r|s|z])es$", "$1"); //ex. amor
        inflect.addSingularize("([r|z])es$", "$1"); //ex. amor
...
//        inflect.addSingularize("(quiz)zes$", "$1");
        ...
        */
        ...
        inflect.addIrregular("abdomen","abdomens");
        inflect.addIrregular("software","softwares");
	inflect.addIrregular("alemao","alemaes");
	inflect.addIrregular("artesa" , "artesaos");
	inflect.addIrregular("bencao" , "bencaos");
	inflect.addIrregular("cao" , "caes");
	inflect.addIrregular("capelao" , "capelaes");
	inflect.addIrregular("capitao" , "capitaes");
	inflect.addIrregular("chao" , "chaos");
	inflect.addIrregular("charlatao" , "charlataes");
	inflect.addIrregular("cidadao" , "cidadaos");
	inflect.addIrregular("consul" , "consules");
	inflect.addIrregular("cristao" , "cristaos");
	inflect.addIrregular("dificil" , "dificeis");
	inflect.addIrregular("email" , "emails");
	inflect.addIrregular("escrivao" , "escrivaes");
	inflect.addIrregular("fossel" , "fosseis");
	inflect.addIrregular("germen" , "germens");
	inflect.addIrregular("grao" , "graos");
	inflect.addIrregular("hifen" , "hifens");
	inflect.addIrregular("irmao" , "irmaos");
	inflect.addIrregular("liquen" , "liquens");
	inflect.addIrregular("mal" , "males");
	inflect.addIrregular("mao" , "maos");
	inflect.addIrregular("orfao" , "orfaos");
	inflect.addIrregular("pais" , "paises");
	inflect.addIrregular("pai" , "pais");
	inflect.addIrregular("pao" , "paes");
	inflect.addIrregular("perfil" , "perfis");
	inflect.addIrregular("projetil" , "projeteis");
	inflect.addIrregular("reptil" , "repteis");
	inflect.addIrregular("sacristao" , "sacristaes");
	inflect.addIrregular("sotao" , "sotaos");
	inflect.addIrregular("tabeliao" , "tabeliaes");
	inflect.addIrregular("release" , "releases");

        inflect.addUncountable("atlas", "lapis", "onibus", "pires", "species", "virus","status");
    }
